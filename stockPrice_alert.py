...
percent = int(input("Enter the percentage change (+/-) you would like to be notified of :"))
...
#change this to the time in seconds to wait between getting new prices
minutes_in_between_checks = 30
...
#            stock_price2=150
   ...
   ${:0.2f}'''.format(stock_price2)))
        ...
        #   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++   
                    ...
                    robot = anki_vector.AsyncRobot('0050169f')
                    robot.connect()
                    robot.behavior.set_head_angle(degrees(30.0))
